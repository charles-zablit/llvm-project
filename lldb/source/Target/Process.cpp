...
// ranges.
static void AddRegion(const lldb_private::MemoryRegionInfo &region, bool try_dirty_pages,
                      CoreFileMemoryRanges &ranges) {
...
static lldb_private::MemoryRegionInfo Intersect(const lldb_private::MemoryRegionInfo &lhs,

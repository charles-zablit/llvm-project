...
public:
  ...
  /// loop read handler set up in StartSTDIOForwarding). The data is wrapped
  /// in an `O` notification and dispatched to the client on the main loop
  /// thread so it serialises against ordinary packet sends.

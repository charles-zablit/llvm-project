...
public:
  ...
  ///
  /// \param req_cols, req_rows Optional client-supplied terminal dimensions.
  ///   If both are non-zero they are used verbatim; otherwise we try the
  ///   parent's actual console window size and fall back to 80x25.
  ///
  /// \return

...
TEST_F(GDBRemoteCommunicationClientTest, GetMemoryRegionInfo) {
  ...
  EXPECT_EQ(lldb_private::MemoryRegionInfo::eDontKnow, region_info.GetMemoryTagged());
  EXPECT_EQ(lldb_private::MemoryRegionInfo::eDontKnow, region_info.IsStackMemory());
  EXPECT_EQ(lldb_private::MemoryRegionInfo::eDontKnow, region_info.IsShadowStack());
  ...
  EXPECT_TRUE(result.get().Success());
  EXPECT_EQ(lldb_private::MemoryRegionInfo::eYes, region_info.GetMemoryTagged());
  EXPECT_EQ(lldb_private::MemoryRegionInfo::eYes, region_info.IsStackMemory());
